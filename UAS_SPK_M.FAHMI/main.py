...
class BaseMethod():
    ...
    @property
    def data(self):
        query = select(tbl_hpModel.hp, tbl_hpModel.harga, tbl_hpModel.ram, tbl_hpModel.kapasitas_baterai, tbl_hpModel.processor, tbl_hpModel.penyimpanan_internal)
        result = session.execute(query).fetchall()
        print(result)
        return [{'hp': tbl_hp.hp, 'harga': tbl_hp.harga, 'ram': tbl_hp.ram, 'kapasitas_baterai': tbl_hp.kapasitas_baterai, 'processor': tbl_hp.processor, 'penyimpanan_internal': tbl_hp.penyimpanan_internal} for tbl_hp in result]
...
class tbl_hp(Resource):
    ...
    def get(self):
        ...
        data = [{'hp': tbl_hp.hp, 'harga': tbl_hp.harga, 'ram': tbl_hp.ram, 'kapasitas_baterai': tbl_hp.kapasitas_baterai, 'processor': tbl_hp.processor, 'penyimpanan_internal': tbl_hp.penyimpanan_internal} for tbl_hp in session.scalars(query)]
